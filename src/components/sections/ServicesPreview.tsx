      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-2xl md:text-4xl font-display font-bold text-black tracking-tight leading-[1.1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              <Link href="/work" className="group block p-8 bg-white border border-black/5 rounded-xl h-full transition-all hover:shadow-2xl hover:shadow-brand-orange/5 hover:-translate-y-2">
                <div className="w-12 h-12 bg-brand-gray-50 rounded-lg flex items-center justify-center mb-6 group-hover:bg-brand-orange group-hover:text-black transition-colors">
                  <service.icon size={24} />
                </div>
                <h3 className="text-lg md:text-xl font-display font-bold mb-3 text-black">{service.title}</h3>
